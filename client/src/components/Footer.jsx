...
export default function FooterCom() {
  return (
    <Footer container className="relative border border-t-8 border-stroke-1">
      <div className="relative w-full max-w-7xl mx-auto z-10">
        <div className="grid w-full justify-between sm:flex md:grid-cols-1">
          <div className="mt-5">
            ...
            >
              <span className="px-2 py-1 bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 rounded-lg text-white">
                AkWebDev
              </span>
              Blog
            </Link>
        ...
        <div className="w-full sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex gap-6 sm:mt-0 mt-4 sm:justify-center">
            <Footer.Icon
              className="text-current dark:hover:text-stroke-1 hover:text-stroke-1 transition-colors"
              href="https://github.com/Krejzy23"
              target="_blank"
              icon={BsGithub}
            />
